...
export default function OpenAccButton({ text, className }: { text: string; className?: string }) {
  return (
    <a href="https://dashboard.flizbar.com/register" className={`flex items-center gap-2 bg-[#A06A08] h-[46px] text-white py-2 px-4 rounded font-bold text-[16px] ${className}`}>
      {text}
